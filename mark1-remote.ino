// this is the code for remote for my tracked robot... well this remote is still the first version...and is not advanced...the next version will be way more complicated...but still keeping it' for backup..as i'm not disassembling the previous remote circuit...just in case the new one wont work
